...
@Component({
  ...
  styleUrl: './waiting-invoices.component.scss'
})
export class WaitingInvoicesComponent {
  ...
  ngAfterViewInit(): void {
      this.paginator.page.pipe(
        ...
        switchMap(() => {
          ...
          return this.billingService.getInvoiceNotPaidByPage(this.paginator.pageIndex, this.pageSize).pipe(catchError(() => of(null)));
        }),
        map(data => {
